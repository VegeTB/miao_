...
weapons_major= [
    ...
    "CB-9 爆燃弩","R-36 爆裂铳","ARC-12 雷霆","LAS-5 长柄镰","FLAM-66火炬手","SG-8P 等离子制裁者","PLAS-1 焦土","PLAS-101净化者","R-6 鹰眼", "PLAS-39 加速步枪"
]

weapons_sec = [
    "P-2 和平制造者", "P-19 救世主", "P-113 裁决者", "P-4 参议员", "GP-31 最后通牒", "GP-31 榴弹手枪",
    "P-72 打火机", "PLAS-15 忠诚", "LAS-7 匕首", "SG-22 游击兵", "P-11 治疗剂手枪", "CQC-19 眩晕长矛",
    "CQC-30 眩晕短棍", "CQC-5 战术斧", "LAS-58 猛爪"
]
...
arms = [
    "应对自如", "高效过滤", "电路导管", "工程包", "额外垫料", "强化", "易燃易爆", "集成炸药", "医疗包",
    "强健体格", "侦察", "伺服辅助", "蓄势出击", "毫不畏缩", "神枪手"
]
...
class miaomiao(Star):
    ...
    async def ram_stm(self, event: AstrMessageEvent):
        ...
        stm = [
            ...
            "防弹护盾背包", "能量护盾背包", "定向护盾", "便携式地狱火背包","悬浮背包",
